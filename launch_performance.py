#!/usr/bin/env python
"""
BROski Bot 3.0 - Performance Dashboard Launcher
Quick utility to start the performance dashboard
"""
import os
import sys
import subprocess
...
def main():
    ...
    print(f"{Fore.CYAN}BROski Bot - Performance Dashboard Launcher")
    print(f"{Fore.CYAN}=" * 70)
    ...
    if not os.path.exists(dashboard_path):
        print(f"{Fore.RED}Error: Performance dashboard file not found at {dashboard_path}")
        return False
    
    print(f"{Fore.GREEN}Starting Performance Dashboard...")
    ...
    try:
        ...
        print(f"\n{Fore.YELLOW}Performance dashboard stopped.")
        return True
